...
int main(void) {
	...
	if (!dir_exists("src") || !dir_exists("include")) {
		fprintf(stderr, "Error: 'src' and 'include' directories not found in the current folder.\n");
		return 1;
	}
	...
	printw("Enter class names (space-separated):\n> ");
	echo();
